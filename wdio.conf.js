//importing generic configuration file
...
exports.config = {
    ...
    reporters: [
        ['allure', {
        outputDir: './Outputs/allure-report',
 ...
 //
    ...
    cucumberOpts: {
        ...
        timeout: baseConfig.stepDefinitionTimeout,     // <number> timeout for step definitions
     ...
     */
     afterStep: function (uri, feature, { error, result, duration, passed }, stepData, context) {
        var date = Date.now();
        browser.saveScreenshot('./Outputs/screenShots/Chrome_' + date + '.png')
     },
    /**
